...
add_action('init', function() {
  ...
  $ps_domain = get_option(UBConfig::UB_PAGE_SERVER_DOMAIN_KEY);
...
function render_unbounce_pages($domain_info, $domain) {
  ...
  echo get_submit_button('Authorize With Unbounce',
                         ...
                         array('data-set-domains-url' => $set_domains_url,
                               ...
                               'data-api-url' => get_option(UBConfig::UB_API_URL_KEY),
                               'data-api-client-id' => get_option(UBConfig::UB_API_CLIENT_ID_KEY)));
  echo '</form>';
